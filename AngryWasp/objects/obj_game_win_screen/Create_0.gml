/// Game win screen object
// Created and exists when the game is in a game win state (player finishes game)

// Stops the current game music
audio_stop_sound(global.music);

// Plays the win music sting
global.music = audio_play_sound(snd_win_music_new, 100, false);
